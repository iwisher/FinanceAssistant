...
def gemini_chat(file_path, history=[]):
  ...
  response_summary = chat_session .send_message(["Identify and summarize the main themes discussed in the audio regarding monetory policy, fiscal policy,  finance and stock markets, including specific examples and key data points. Pay particular attention to  the roles and perspectives of key players such as finance insitituion, goverment, fed and such as. Please also help generate the search keywords for each topic for further research.  Thanks!.",files[0]])
